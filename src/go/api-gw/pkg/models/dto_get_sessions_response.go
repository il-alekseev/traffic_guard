...
// DtoGetSessionsResponse dto get sessions response
//
...
func (m *DtoGetSessionsResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DtoGetSessionsResponse) validateData(formats strfmt.Registry) error {
...
func (m *DtoGetSessionsResponse) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *DtoGetSessionsResponse) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *DtoGetSessionsResponse) UnmarshalBinary(b []byte) error {
	var res DtoGetSessionsResponse
